...
"`name` varchar(100),"+
    ...
    void insert() {
        ...
        String productName = "Konto EUW";
        jdbcTemplate.update("INSERT INTO `products` (id,name) values (?,?)", productId, productName);
    ...
    HashMap<String,Object> loaded= jdbcTemplate.queryForObject(querySql,new Object[]{productId},
            (r,i) ->{
